...
public class AdapterLTLT extends BaseAdapter {
    public static List<Coursee> arrNguoiDung;
    private Context context;
    private LayoutInflater inflater;


    public AdapterLTLT(LichThiActivity context, List<Coursee> arrNguoiDung){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Coursee _entry = (Coursee) arrNguoiDung.get(i);
