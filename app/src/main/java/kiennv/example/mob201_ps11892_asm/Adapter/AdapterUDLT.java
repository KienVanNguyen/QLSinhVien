...
public class AdapterUDLT extends BaseAdapter {
    public static List<UngDung> arrNguoiDung;
    public Context context;
    private LayoutInflater inflater;

    public AdapterUDLT(LichThiActivity context, List<UngDung> arrNguoiDung) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        AdapterUD.ViewHolder holder;
        if (view == null) {
            holder = new AdapterUD.ViewHolder();
            ...
            holder = (AdapterUD.ViewHolder) view.getTag();
