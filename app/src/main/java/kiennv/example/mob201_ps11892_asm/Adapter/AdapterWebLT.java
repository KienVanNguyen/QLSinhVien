...
import kiennv.example.mob201_ps11892_asm.Activity.LichThiActivity;
import kiennv.example.mob201_ps11892_asm.Model.Web;
import kiennv.example.mob201_ps11892_asm.Model.WebLT;
import kiennv.example.mob201_ps11892_asm.R;

public class AdapterWebLT extends BaseAdapter {
    public static List<Web> arrNguoiDung;
    private Context context;
    private LayoutInflater inflater;
    public AdapterWebLT(LichThiActivity context, List<Web> arrNguoiDung1){
        this.arrNguoiDung = arrNguoiDung1;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Web _entry = (Web) arrNguoiDung.get(i);
